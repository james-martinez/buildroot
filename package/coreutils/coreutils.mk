...
COREUTILS_CONF_OPT = --disable-rpath --enable-single-binary=symlinks \
...
COREUTILS_CONF_OPT += --disable-acl
endif

ifeq ($(BR2_PACKAGE_ATTR),y)
COREUTILS_DEPENDENCIES += attr
else
COREUTILS_CONF_OPT += --disable-xattr
endif
...
COREUTILS_CONF_OPT += --with-libintl-prefix=$(STAGING_DIR)/usr
endif

ifeq ($(BR2_PACKAGE_GMP),y)
COREUTILS_DEPENDENCIES += gmp
else
COREUTILS_CONF_OPT += --without-gmp
endif

ifeq ($(BR2_PACKAGE_LIBCAP),y)
COREUTILS_DEPENDENCIES += libcap
else
COREUTILS_CONF_OPT += --disable-libcap
endif

ifeq ($(BR2_PACKAGE_OPENSSL),y)
COREUTILS_CONF_OPT += --with-openssl=yes
...
COREUTILS_CONF_OPT += --enable-no-install-program=stdbuf
endif
